...
public class DistributionWorkloadGenerator implements WorkloadGenerator {
    ...
    private HyperExponential interarrival;
    ...
    protected HyperExponential getInterarrival() {
        return interarrival;
    }

    protected void setInterarrival(HyperExponential newInterarrival) {
        this.interarrival = newInterarrival;
    }
